...
class UyeSignUp extends StatefulWidget {
  @override
...
class _UyeSignUp extends State {
    ...
    children: [
      ...
      Container(
        ...
        child: TextField(
          maxLength: 25,
          controller: name,
          style: TextStyle(color: Colors.white, fontFamily: "GeosansLight"),
          decoration: InputDecoration(
              counter: Offstage(),
              border: InputBorder.none,
              contentPadding: EdgeInsets.only(top: 14.0),
